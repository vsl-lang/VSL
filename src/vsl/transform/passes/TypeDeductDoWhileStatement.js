...
/**
 * Type deducts do-while-statements. Requires resolution to a bool type.
 */
export default class TypeDeductDoWhileStatement extends Transformation {
    constructor() {
        super(t.DoWhileStatement, "TypeDeduct::DoWhileStatement");
    }
